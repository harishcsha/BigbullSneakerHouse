    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-16 sm:py-24">
      <div className="flex items-end justify-between mb-8 flex-wrap gap-4">
        <div className="min-w-0 max-w-full">
          <p className="font-tag text-cyan text-xs uppercase tracking-widest mb-2">Landmark</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-0 border border-white/10">
        <div className="lg:col-span-3 h-72 sm:h-96 lg:h-auto">
          <iframe
            title="BigBull Sneaker House location"
        ...
        <div className="lg:col-span-2 bg-surface p-6 sm:p-8 flex flex-col justify-center gap-6">
          <div className="flex gap-3">
            <FiMapPin className="text-cyan shrink-0 mt-1" size={20} />
            <div>
          ...
          <div className="flex gap-3">
            <FiClock className="text-cyan shrink-0 mt-1" size={20} />
            <div>
              <p className="font-body font-bold text-bone">Store Hours</p>
              <p className="font-body text-mute text-sm mt-1">Mon – Sun · 11:00 AM – 9:00 PM</p>
            </div>
          </div>
          <a
            ...
            className="inline-flex items-center justify-center gap-2 border-2 border-cyan text-cyan font-body font-bold py-3 hover:bg-cyan hover:text-ink transition-colors"
          >
