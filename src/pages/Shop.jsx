...
export default function Shop() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 pt-28 sm:pt-32 pb-24">
      <div className="mb-10">
        <p className="font-tag text-cyan text-xs uppercase tracking-widest mb-2">The Full Rack</p>
        <h1 className="font-display text-4xl sm:text-5xl tracking-wide">SHOP THE GALLERY</h1>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:items-center justify-between mb-10 pb-6 border-b border-white/10">
        ...
        <select
          ...
          className="bg-surface border border-white/15 text-bone font-body text-sm px-3 py-2 focus:border-cyan"
        >
