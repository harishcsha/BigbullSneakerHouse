...
export default function OrderConfirmed() {
  return (
    <div className="max-w-2xl mx-auto px-4 pt-40 pb-24 text-center">
      <FiCheckCircle className="text-cyan mx-auto mb-6" size={56} />
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <a
          ...
          className="border-2 border-white/20 text-bone font-display px-8 py-3 tracking-wide hover:border-cyan hover:text-cyan transition-colors"
        >
          MESSAGE THE SHOP
        </a>
      </div>
